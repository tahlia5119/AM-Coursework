# -*- coding: utf-8 -*-
"""
Created on Mon Jan  7 23:13:24 2019
...
# Use f1_score to look at performance since there will be an imbalance of classes
...
f1score = f1_score(y_test,encoder.inverse_transform(predictions),average='weighted')
matrix = confusion_matrix(y_test,encoder.inverse_transform(predictions))